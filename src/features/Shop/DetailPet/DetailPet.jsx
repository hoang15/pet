  ...
  const handleAddCart = (infor) => {
    ...
    if (isExist) {
      if (isExist.quantityCurrent !== quantityNumber) {
        ...
        messageShowSuccess("Update number successfully!");
      } else {
        messageShowErr("Products already in the cart!");
      }
    } else {
      dispatch(addListCart(infor));
      messageShowSuccess("Add cart successfully!");
    }
  };
          ...
          <Grid item lg={7} md={7} sm={7} xs={12}>
            <div className="item-content">
              ...
              <div className="quantity">
                <div className="title">Amount: {data?.quantity}</div>
                <div className="title">
