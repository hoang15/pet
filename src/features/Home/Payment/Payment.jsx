...
export default function Payment({
  ...
  return (
    <div className="payment">
      ...
      >
        <DialogTitle id="form-dialog-title">Pay</DialogTitle>
        <DialogContent>
          <div className="infor">
            <div className="infor_title">Product information</div>
              ...
              {listCart?.map((ok, index) => (
                <div className="box" key={index}>
                  ...
                  <div className="box_content">
                    <div className="item">Amount: {ok.quantityCurrent}</div>
                    <div className="item">
          ...
          <div className="result">Into money: {handleGetResult()}vnđ</div>
          <form>
        ...
        >
          <DialogTitle id="alert-dialog-slide-title">Notify</DialogTitle>
          <DialogContent>
            <DialogContentText id="alert-dialog-slide-description">
              Do you agree to continue with the transaction? You cannot cancel
              delivery translate when click continue.
            </DialogContentText>
          </DialogContent>
          <DialogActions>
